...
@implementation SetViewController1
...
- (UITableView *)tableview{
    if (_tableview == nil) {
        ...
        [_tableview registerNib:[UINib nibWithNibName:@"SetTableViewCell1" bundle:nil] forCellReuseIdentifier:@"SetTableViewCell1"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    SetTableViewCell1 *cell=[tableView dequeueReusableCellWithIdentifier:@"SetTableViewCell1"];
    if (!cell) {
        cell=[[SetTableViewCell1 alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"SetTableViewCell1"];
    }
