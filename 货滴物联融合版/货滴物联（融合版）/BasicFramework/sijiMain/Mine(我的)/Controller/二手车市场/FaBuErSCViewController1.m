...
#import "FabuTableViewCell1.h"
#import "HomeMapViewC11.h"
#import "NSDate+BRAdd.h"

@interface FaBuErSCViewController1 ()<UITableViewDataSource,UITableViewDelegate,SDCycleScrollViewDelegate,UITextFieldDelegate,UIActionSheetDelegate,UINavigationControllerDelegate,UIImagePickerControllerDelegate>
...
@implementation FaBuErSCViewController1
{
...
- (UITableView *)tableview{
    if (_tableview == nil) {
        ...
        [_tableview registerClass:[FabuTableViewCell1 class] forCellReuseIdentifier:NSStringFromClass([FabuTableViewCell1 class])];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    Class MainClass = [FabuTableViewCell1 class];
    FabuTableViewCell1 *cell = nil;
...
- (void)buttonClick:(UIButton *)but{
    switch (but.tag) {
        ...
        case 5:{
            HomeMapViewC11 *map = [[HomeMapViewC11 alloc]init];
