...
@interface MyYeEViewController1 ()<UITableViewDataSource,UITableViewDelegate>
{
...
@implementation MyYeEViewController1
...
- (void)mingxiClick{
    MingXiViewController1 *MXVC = [[MingXiViewController1 alloc]init];
    [self.navigationController pushViewController:MXVC animated:YES];
}
- (void)chongzhiButClick{
    ChongZhiViewController1 *chongzhi = [[ChongZhiViewController1 alloc]init];
    [self.navigationController pushViewController:chongzhi animated:YES];
}
- (void)tixianButClick{
    TiXianViewController1 *tixian = [[TiXianViewController1 alloc]init];
