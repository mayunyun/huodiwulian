...
#import "TiBanWuLiuSJRZViewCellNew1.h"
#import "TiBanWuLiuSJRZViewCellNewPart1.h"
#import "WuLiuSJRZPhoneCellNew1.h"
#import "TiBanWuLiuSjrzIngViewControllerNew1.h"
@interface TiBanWuLiuSJRZViewControllerNew1 ()<UITableViewDataSource,UITableViewDelegate,UIActionSheetDelegate,UINavigationControllerDelegate,UIImagePickerControllerDelegate,UITextFieldDelegate>
...
@implementation TiBanWuLiuSJRZViewControllerNew1
{
    UIButton *foodBut;
    NSString * yzmCode;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.section == 0) {
        static NSString * stringCell = @"TiBanWuLiuSJRZViewCellNew1";
        TiBanWuLiuSJRZViewCellNew1 * cell = [tableView dequeueReusableCellWithIdentifier:stringCell];
        if (cell == nil) {
        ...
        cell.threeImage.tag = 1102+indexPath.section;//1105//1106
        [cell.threeImage addGestureRecognizer:tap3];
        cell.threeImage.image = self.imageArr[indexPath.section+1];
        return cell;
...
- (void)butHideClick{
    [SMAlert hide:NO];
    TiBanWuLiuSjrzIngViewControllerNew1 *sjrz = [[TiBanWuLiuSjrzIngViewControllerNew1 alloc]init];
...
- (void)textFieldDidEndEditing:(UITextField *)textField{
    ...
    TiBanWuLiuSJRZViewCellNew1 *cell = [self.tableview cellForRowAtIndexPath:indexPath];
    ...
    TiBanWuLiuSJRZViewCellNewPart1 * cell1 = [self.tableview cellForRowAtIndexPath:indexPath1];
    if (textField == cell1.license_type) {
