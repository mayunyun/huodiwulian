...
#import "WuLiuSJRZViewCell1.h"
#import "WuLiuSJRZPhoneCell1.h"
#import "WuLiuSjrzIngViewController1.h"
#import "TiBanWuLiuSJRZViewController.h"

@interface WuLiuSJRZViewController1 ()<UITableViewDataSource,UITableViewDelegate,UIActionSheetDelegate,UINavigationControllerDelegate,UIImagePickerControllerDelegate,UITextFieldDelegate>
...
@implementation WuLiuSJRZViewController1
{
    UIButton *foodBut;
    NSString * yzmCode;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.section == 0) {
        static NSString * stringCell = @"WuLiuSJRZViewCell1";
        WuLiuSJRZViewCell1 * cell = [tableView dequeueReusableCellWithIdentifier:stringCell];
        if (cell == nil) {
        ...
        static NSString * stringCell = @"WuLiuSJRZPhoneCell1";
        WuLiuSJRZPhoneCell1 * cell = [tableView dequeueReusableCellWithIdentifier:stringCell];
        if (cell == nil) {
            cell = [[[NSBundle mainBundle]loadNibNamed:stringCell owner:nil options:nil]lastObject];
        }
...
- (void)butHideClick{
    [SMAlert hide:NO];
    WuLiuSjrzIngViewController1 *sjrz = [[WuLiuSjrzIngViewController1 alloc]init];
...
- (void)textFieldDidEndEditing:(UITextField *)textField{
    ...
    WuLiuSJRZViewCell1 *cell = [self.tableview cellForRowAtIndexPath:indexPath];
...
{
    TiBanWuLiuSJRZViewController *tiban = [[TiBanWuLiuSJRZViewController alloc]init];
