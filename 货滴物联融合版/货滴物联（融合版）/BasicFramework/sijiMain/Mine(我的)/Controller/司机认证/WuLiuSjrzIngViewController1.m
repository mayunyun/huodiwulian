...
#import "WuLiuSjrzIngViewCell1.h"
#import "WuLiuSJRZPhoneCell1.h"
#import "WuLiuSJRZViewController1.h"
@interface WuLiuSjrzIngViewController1 ()<UITableViewDataSource,UITableViewDelegate,UIActionSheetDelegate>
...
@implementation WuLiuSjrzIngViewController1
...
- (void)foodButClick{
    jxt_showAlertTwoButton(@"提示", @"您确定需要重新提交审核吗？", @"确定", ^(NSInteger buttonIndex) {
        WuLiuSJRZViewController1 *sjrz = [[WuLiuSJRZViewController1 alloc]init];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.section == 0) {
        static NSString * stringCell = @"WuLiuSjrzIngViewCell1";
        WuLiuSjrzIngViewCell1 * cell = [tableView dequeueReusableCellWithIdentifier:stringCell];
        if (cell == nil) {
