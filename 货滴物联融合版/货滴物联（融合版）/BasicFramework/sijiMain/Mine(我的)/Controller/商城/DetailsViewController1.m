...
#import "DetailsModel1.h"
#import "YJTagView1.h"
#import "LoginVC1.h"

@interface DetailsViewController1 ()<SDCycleScrollViewDelegate,YJTagViewDelegate, YJTagViewDataSource,UIWebViewDelegate>{
    UIScrollView* _bgsView;
    UIView *bgview;
    UILabel * proDetailLabel;
    UIWebView *webView;

    YJTagView1 *_typeview;
    YJTagView1 *_colorview;
...
@property (nonatomic, strong) ShopcartCountView1 *ShopcartCountView1;
@property (nonatomic, strong) DetailsModel1 *model;
...
- (void)loadNew{
    ...
    [[RequestTool1 sharedRequestTool].UserRequestTool1 loginWithUrl:URLStr Parameters:params FinishedLogin:^(id responseObject) {
        ...
        NSLog(@"详情%@",array);
        if (array.count) {
            _model=[[DetailsModel1 alloc]init];
...
-(void)createUI{
    ...
    _colorview = [[YJTagView1 alloc] initWithFrame:CGRectMake(70+49*MYWIDTH, titleLabel1.top, UIScreenW-85-49*MYWIDTH, _colorviewheight)];
    ...
    _typeview = [[YJTagView1 alloc] initWithFrame:CGRectMake(70+49*MYWIDTH, titleLabel2.top, UIScreenW-85-49*MYWIDTH, _typeviewheight)];
    ...
    _ShopcartCountView1 = [[ShopcartCountView1 alloc] init];
    _ShopcartCountView1.frame = CGRectMake(70+49*MYWIDTH, titleLabel3.top, 100*MYWIDTH, 30*MYWIDTH);
    
    __weak __typeof(self) weakSelf = self;
    [self.ShopcartCountView1 configureShopcartCountView1WithProductCount:1 productStock:1000];
    _ShopcartCountView1.ShopcartCountView1EditBlock = ^(NSInteger count){
        NSLog(@"%zd",count);
        _countNum = [NSString stringWithFormat:@"%zd",count];
        [weakSelf.ShopcartCountView1 configureShopcartCountView1WithProductCount:count productStock:1000];
        
    };
    [bgview addSubview:_ShopcartCountView1];
...
- (void)shoporderWithToUUIDJiFen{
    ...
    [[RequestTool1 sharedRequestTool].UserRequestTool1 loginWithUrl:URLStr Parameters:params FinishedLogin:^(id responseObject) {
        ...
        if ([str2 rangeOfString:@"false"].location!=NSNotFound) {
            ...
            ShopOrderViewController1 *shoporder = [[ShopOrderViewController1 alloc]init];
            shoporder.uuid = str2;
