...
@interface MYYAllOrderViewController1 ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MYYAllOrderViewController1{
...
- (void)dataRequest{
    ...
    NSDictionary* params = @{@"params":[NSString stringWithFormat:@"{\"orderstatus\":\"%@\"}",@""],@"page":[NSString stringWithFormat:@"%li",(long)_page],@"rows":@"8"};
