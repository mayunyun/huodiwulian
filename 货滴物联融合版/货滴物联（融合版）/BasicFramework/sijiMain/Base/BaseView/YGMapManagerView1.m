...
#import "YGMapManagerView1.h"
#import "YGAnnotation1.h"

@interface YGMapManagerView1 ()<MKMapViewDelegate,CLLocationManagerDelegate>
{
...
@implementation YGMapManagerView1
...
{
    if ([annotation isKindOfClass:[YGAnnotation1 class]]) {
        
        static NSString *identifier = @"YGAnnotation1";
...
//            annotationView.leftCalloutAccessoryView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"88"]];
        ...
        annotationView.image = ((YGAnnotation1 *)annotation).image;
