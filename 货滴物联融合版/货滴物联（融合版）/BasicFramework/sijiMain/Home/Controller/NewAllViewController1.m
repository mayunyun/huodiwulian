...
@interface NewAllViewController1 ()<UIWebViewDelegate>

@end

@implementation NewAllViewController1
...
- (void)wxlogin{
    ...
    [[LSActionView1 sharedActionView] setContainerColor:[UIColor whiteColor]];
