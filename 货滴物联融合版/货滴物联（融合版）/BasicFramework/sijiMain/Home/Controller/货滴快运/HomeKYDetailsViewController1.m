//
//  HomeKYDetailsViewController1.m
//  BasicFramework
//
...
@interface HomeKYDetailsViewController1 ()<UIScrollViewDelegate>
@property(nonatomic,strong) UIScrollView *ScrollView;
@property(nonatomic,strong) NSMutableDictionary *Dictionary;

@end

@implementation HomeKYDetailsViewController1
...
-(void)setUIBGWithView{
    ...
    if ([[_Dictionary objectForKey:@"remarks"] length]<1) {
        [remarksLab setText:@"无"];
    }else{
...
-(void)fahuodanButClicked:(UIButton *)but{
    [SMAlert hide:NO];
    //[self.navigationController popViewControllerAnimated:YES];
//    ShopPageVC1 *tongch = [[ShopPageVC1 alloc]init];
//    tongch.push = @"1";
