...
@interface TongChXiaoViewController1 ()<UITableViewDataSource,UITableViewDelegate>
@property(nonatomic,strong)UITableView *tableview;
@property (nonatomic,strong)NSMutableArray * dataArr;

@end

@implementation TongChXiaoViewController1
{
    NSInteger _page;
}
...
- (void)loadNewSearchSuyunorder
{
    ...
    NSString *URLStr = @"/mbtwz/logisticssendwz?action=searchfindSuyunorder";
