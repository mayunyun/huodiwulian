//
//  TCHKuaiYOrderDetailHeaderCell1.m
//  BasicFramework
//
...
#import "TCHKuaiYOrderDetailHeaderCell1.h"

@implementation TCHKuaiYOrderDetailHeaderCell1
-(void)setModel:(TCHKuaiYModel1 *)model{
    _model = model;
