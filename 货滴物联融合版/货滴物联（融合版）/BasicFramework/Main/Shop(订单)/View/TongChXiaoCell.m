...
- (void)setwithDataModel:(TCHXiaoJModel *)dataModel
{
    ...
    [_timeView setText:[NSString stringWithFormat:@"订单生成时间:%@",_dataModel.createtime]];
    ...
    [_priceView setText:[NSString stringWithFormat:@"￥%.2f",[_dataModel.ordertotalprice floatValue]]];
    [_nameView setText:[NSString stringWithFormat:@"%@",_dataModel.consigneename]];
