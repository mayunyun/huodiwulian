...
- (id)initWithAnnotation:(id<MAAnnotation>)annotation reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self)
    {
        self.bounds = CGRectMake(0.f, 20*MYWIDTH, 40*MYWIDTH, 60*MYWIDTH);
        
        self.backgroundColor = [UIColor clearColor];
        
        /* Create portrait image view and add to view hierarchy. */
        self.portraitImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 30*MYWIDTH, 40*MYWIDTH, 30*MYWIDTH)];
        [self addSubview:self.portraitImageView];
        
        /* Create name label. */
        self.nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(2*MYWIDTH,
                                                                   2*MYWIDTH,
                                                                   36*MYWIDTH,20*MYWIDTH)];
