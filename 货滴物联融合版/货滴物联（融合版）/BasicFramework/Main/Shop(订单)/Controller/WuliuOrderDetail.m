...
@interface WuliuOrderDetail ()<UITableViewDataSource,UITableViewDelegate,CDZStarsControlDelegate,UITextViewDelegate,MAMapViewDelegate,PLTagViewDelegate, PLTagViewDataSource>
...
-(void)CommitBtnClicked:(UIButton *)sender{
    ...
    if ([_inputTV.text isEqualToString:@""]) {//默认不填任何信息是好评
        dic =@{@"order_id":model.id,@"driver_fraction":starScore,@"note":@"默认好评",@"driverid":model.driver_custid,@"ordertype":@"1",@"evalute_type":@"0",@"selevalueids":str1};
    }else{
        dic =@{@"order_id":model.id,@"driver_fraction":starScore,@"note":_inputTV.text,@"driverid":model.driver_custid,@"ordertype":@"1",@"evalute_type":@"0",@"selevalueids":str1};
    }
    NSDictionary* KCparams = @{@"data":[Command dictionaryToJson:dic]};//
    [[RequestTool sharedRequestTool].userRequestTool loginWithUrl:url Parameters:KCparams FinishedLogin:^(id responseObject) {
...
-(void)startOrder{
    ...
    NSDictionary * dic =@{@"orderno":model.orderno};
    NSDictionary* KCparams = @{@"data":[Command dictionaryToJson:dic]};//
    [[RequestTool sharedRequestTool].userRequestTool loginWithUrl:url Parameters:KCparams FinishedLogin:^(id responseObject) {
        NSString * str = [[NSString alloc]initWithData:responseObject encoding:NSUTF8StringEncoding];
        NSLog(@"开始订单%@",str);
...
-(void)DriverSyData{
    ...
    NSDictionary * dic =@{@"orderno":model.orderno,@"owner_createtime":model.createtime,@"siji_findtime":model.pickuptime,@"order_money":model.ordertotalprice,@"driverid":model.driver_custid};
    NSDictionary* KCparams = @{@"data":[Command dictionaryToJson:dic]};//
    [[RequestTool sharedRequestTool].userRequestTool loginWithUrl:url Parameters:KCparams FinishedLogin:^(id responseObject) {
        NSString * str = [[NSString alloc]initWithData:responseObject encoding:NSUTF8StringEncoding];
        NSLog(@"司机失约%@",str);
...
-(void)cancelOrderData{
    ...
    NSDictionary * dic =@{@"orderno":model.orderno,@"owner_createtime":model.createtime,@"siji_findtime":model.pickuptime,@"order_money":model.ordertotalprice};
    NSDictionary* KCparams = @{@"data":[Command dictionaryToJson:dic]};//
    [[RequestTool sharedRequestTool].userRequestTool loginWithUrl:url Parameters:KCparams FinishedLogin:^(id responseObject) {
        NSString * str = [[NSString alloc]initWithData:responseObject encoding:NSUTF8StringEncoding];
        NSLog(@"取消订单%@",str);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.section == 0) {
        ...
        if (_detailArr.count) {
            TCHXiaoJModel * model = _detailArr[0];
            cell.price.text = [NSString stringWithFormat:@"%.2f",[model.ordertotalprice floatValue]];
        }
