...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSArray * arr1 = @[@[@"余额"],@[@"订单"],@[@"实名认证",@"联系客服",@"安全中心",@"用户指南"]];
    NSArray * arr2 = @[@[@"优惠券"],@[@"账单"],@[@"货滴车市",@"关于我们",@"应用下载",@"常见问题"]];
    NSArray * arr3 = @[@[@"发票与报销"],@[@"商城"],@[@"行业资讯",@"版本更新",@"意见与建议",@"退出登录"]];
...
- (void)but2Click:(UIButton *)but{
    [Command isloginRequest:^(bool str) {
        if (str) {
            switch (but.tag) {
                case 210:{
                    CarshopViewController *HuodongVC = [[CarshopViewController alloc]init];
...
- (void)initSubViewUI{
    ...
    _titlelabel = [[UILabel alloc]initWithFrame:CGRectMake(_headview.right +10*MYWIDTH, _headview.top+20*MYWIDTH, 150*MYWIDTH, 25*MYWIDTH)];
