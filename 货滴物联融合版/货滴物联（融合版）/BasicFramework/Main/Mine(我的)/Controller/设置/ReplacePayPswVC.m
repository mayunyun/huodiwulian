...
#define SendTime 60
@interface ReplacePayPswVC ()<UITextFieldDelegate>
{
...
@implementation ReplacePayPswVC
...
- (void)creatUI{
    ...
    headimgView.image = [UIImage imageNamed:@"修改支banner"];
    ...
    [_ecodeBtn setBackgroundColor:UIColorFromRGB(0x479af7)];
    ...
    [_okBtn setBackgroundColor:UIColorFromRGB(0x479af7)];
    ...
    _okBtn.layer.cornerRadius = 3*MYWIDTH;
...
- (void)isExitsPhoneRequest{
    ...
    [[RequestTool sharedRequestTool].userRequestTool loginWithUrl:@"/mbtwz/register?action=isExitsPhone" Parameters:params FinishedLogin:^(id responseObject) {
...
- (void)registRequest{
     ...
     */
    NSString* urlstr = @"/mbtwz/register?action=upzhifuPassword";
    _phoneField.text = [Command convertNull:_phoneField.text];
