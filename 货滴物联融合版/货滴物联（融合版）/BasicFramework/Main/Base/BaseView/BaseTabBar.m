...
- (void)setWithSeccessView{
    ...
    [butSY setTitle:@"发布货源" forState:UIControlStateNormal];
    ...
    [butBJ setTitle:@"发布招聘" forState:UIControlStateNormal];
    ...
    [butBJ addTarget:self action:@selector(SZbutHideClick) forControlEvents:UIControlEventTouchUpInside];
