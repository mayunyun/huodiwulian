...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSArray *imageArr = @[@"共享货车1",@"省际城际1",@"zixun-1",@"替班司机1",@"货滴车市1",@"qianbao"];
    
    NSArray *nameArr = @[@"回程货车",@"货源发布",@"货主之家",@"替班司机",@"货滴车市",@"我的钱包"];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.row==0) {
        ...
        SiJiHomeViewController *newxw = [[SiJiHomeViewController alloc]init];
        ...
        CarshopViewController *regiVc = [[CarshopViewController alloc]init];
        regiVc.hidesBottomBarWhenPushed = YES;
        [self.navigationController pushViewController:regiVc animated:YES];
...
//    [self.navigationItem.leftBarButtonItem setTintColor:MYColor];
    ...
    //货主端是false
    [userdefalut setBool:false forKey:IsHdsjOrHdhz];
    ...
    [titleImageView setTitle:@" 货主端[切换]" forState:UIControlStateNormal];
...
-(void)titleImageViewclick{
    ...
    istype = !istype;
    [userdefault setBool:istype forKey:IsHdsjOrHdhz];
