...
- (Hardware)hardware {
    ...
    if ([hardware isEqualToString:@"iPhone11,6"])    return IPHONE_XS_MAX;
...
- (float)hardwareNumber:(Hardware)hardware {
    switch (hardware) {
        ...
        case IPHONE_7:         return 9.1f;//10.1f
        case IPHONE_7_PLUS:         return 9.2f;//10.2f
        case IPHONE_8:          return 10.1f;
        case IPHONE_8_PLUS:     return 10.2f;
        case IPHONE_X:     return 10.3f;
        case IPHONE_XS:     return 11.2f;
        case IPHONE_XS_MAX:     return 11.6f;
        case IPHONE_XR:     return 11.8f;
