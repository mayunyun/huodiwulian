...
#define IPHONE_X_Group ([[UIDevice currentDevice] hardware] == IPHONE_XS||[[UIDevice currentDevice]hardware] == IPHONE_X||[[UIDevice currentDevice] hardware] == IPHONE_XS_MAX||[[UIDevice currentDevice]hardware] == IPHONE_XR)
