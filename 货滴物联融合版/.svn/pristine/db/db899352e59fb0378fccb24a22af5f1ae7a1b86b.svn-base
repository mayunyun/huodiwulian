...
@interface CoreViewController1 ()<UINavigationControllerDelegate,UIImagePickerControllerDelegate,AVCaptureMetadataOutputObjectsDelegate, UIAlertViewDelegate>
{
...
@implementation CoreViewController1
...
- (void)alertMetadataObjectData:(NSString *)data{
    ...
    if ([self isUrl:data]) {
        ...
        CoreTitleViewViewController1 *titleVIew = [[CoreTitleViewViewController1 alloc]init];
...
- (void)addAnimation{
    ...
    line.hidden = NO;
    CABasicAnimation *animation = [CoreViewController1 moveYTime:2 fromY:[NSNumber numberWithFloat:5] toY:[NSNumber numberWithFloat:255*MYWIDTH] rep:OPEN_MAX];
