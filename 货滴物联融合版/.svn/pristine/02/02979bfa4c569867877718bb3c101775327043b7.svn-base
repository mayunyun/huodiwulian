//
//  MYYTypeDetailsCollectionView1.m
//  BaseFrame
//
...
#import "MYYTypeDetailsCollectionViewCell1.h"
#import "XWMainModel.h"
@interface MYYTypeDetailsCollectionView1 ()

@end
@implementation MYYTypeDetailsCollectionView1
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        //注册单元格
        [self registerNib:[UINib nibWithNibName:@"MYYTypeDetailsCollectionViewCell1" bundle:nil] forCellWithReuseIdentifier:@"MYYTypeDetailsCollectionViewCell1"];
    }
...
{//UICollectionViewCell里的属性非常少，实际做项目的时候几乎必须以其为基类定制自己的Cell
    ...
    static NSString *HomeSelarCellID = @"MYYTypeDetailsCollectionViewCell1";
    
    //在这里注册自定义的XIBcell 否则会提示找不到标示符指定的cell
    UINib *nib = [UINib nibWithNibName:@"MYYTypeDetailsCollectionViewCell1" bundle: [NSBundle mainBundle]];
    [self registerNib:nib forCellWithReuseIdentifier:HomeSelarCellID];
    
    MYYTypeDetailsCollectionViewCell1*cell = [collectionView dequeueReusableCellWithReuseIdentifier:HomeSelarCellID forIndexPath:indexPath];
