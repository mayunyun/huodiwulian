...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        self.iconSize = CGSizeMake(15, 15);
        self.iconLeftMargin = 15*MYWIDTH;
        self.iconRightMargin = 15*MYWIDTH;
        
        
        //公共属性的  默认属性的赋值<assign>
        self.cellClassName = @"FFDropDownMenuCell";
        self.menuWidth = 130*MYWIDTH;
        self.menuCornerRadius = 0;
        self.eachMenuItemHeight = 40;
        self.menuRightMargin = 10;
        self.menuItemBackgroundColor = UIColorFromRGB(0x444444);
        self.triangleColor = [UIColor clearColor];
        self.triangleY = 64;
        self.realTriangleY = self.triangleY-10;
