...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [self.navigationItem.leftBarButtonItem setTintColor:UIColorFromRGBValueValue(0x333333)];
...
-(void)viewWillDisappear:(BOOL)animated
{
    ...
    self.navigationController.navigationBar.barTintColor = UIColorFromRGBValueValue(0x333333);
...
- (void)setNavigation {
    ...
    [btn setImage:[UIImage imageNamed:@"关闭_1"] forState:UIControlStateNormal];
