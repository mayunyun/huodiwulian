...
@interface FeiLeiShopViewController1 ()<UICollectionViewDelegate,UICollectionViewDataSource,UISearchBarDelegate>
@property(nonatomic,strong)UICollectionView *collection;
@property (nonatomic) NSInteger selectedIndex;

@end

@implementation FeiLeiShopViewController1
{
...
- (void)tabbarBut:(UIButton*)but{
    switch (but.tag) {
        case 0:
        {
            NewShopingClassViewController1 *NewShopi = [[NewShopingClassViewController1 alloc]init];
        ...
        case 3:
        {
            MenuViewController1 *Menu = [[MenuViewController1 alloc]init];
...
- (void)searchBarSearchButtonClicked:(UISearchBar *)searchBar {
    ...
    if (!IsEmptyValue(_search.text)) {
        ZongheViewController1 *ZongheVi = [[ZongheViewController1 alloc]init];
