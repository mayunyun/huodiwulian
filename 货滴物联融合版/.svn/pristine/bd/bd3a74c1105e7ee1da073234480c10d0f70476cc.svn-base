...
@implementation xiaoxiTableViewCell1
...
- (void)layoutSubviews{
    ...
    }else if ([_model.mark intValue]==4){
        if ([_model.issee intValue]==0){
            self.imgview.image = [UIImage imageNamed:@"hongbao"];
        }else {
            self.imgview.image = [UIImage imageNamed:@"hongbao2"];
        }
    }
