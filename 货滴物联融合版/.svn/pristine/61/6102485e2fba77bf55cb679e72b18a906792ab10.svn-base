...
@interface OrderSousuoViewController1 ()

@end

@implementation OrderSousuoViewController1{
...
- (IBAction)sousuoButClick:(UIButton *)sender {
    ...
    NSString *url = @"/mbtwz/find?action=searchOrderByParamSJ";
        ...
        if (array.count) {
            ...
            for (NSDictionary*dic in array) {
                if ([_ordertype isEqualToString:@"0"]) {
                    TCHXiaoJModel1 *model=[[TCHXiaoJModel1 alloc]init];
                    [model setValuesForKeysWithDictionary:dic];
                    //追加数据
                    [dataArr addObject:model];
                }else if ([_ordertype isEqualToString:@"1"]){
                    TCHBanJModel1 *model=[[TCHBanJModel1 alloc]init];
                    [model setValuesForKeysWithDictionary:dic];
                    //追加数据
                    [dataArr addObject:model];
            ...
            OrderViewController1 *orderVc = [[OrderViewController1 alloc]init];
