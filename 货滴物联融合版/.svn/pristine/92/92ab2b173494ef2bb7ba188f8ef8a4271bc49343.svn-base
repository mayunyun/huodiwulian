...
#import "SendMessageToWXReq+requestWithTextOrMediaMessage1.h"
#import "WXMediaMessage+messageConstruct1.h"

@implementation WXApiRequestHandler1
...
+ (BOOL)sendAuthRequestScope:(NSString *)scope
    ...
    return [WXApi sendAuthReq:req
               viewController:viewController
                     delegate:[WXApiManager1 sharedManager]];
}
