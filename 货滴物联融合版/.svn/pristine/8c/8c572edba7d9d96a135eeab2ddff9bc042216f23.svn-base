...
@interface ShopingClassViewController1 ()

@end

@implementation ShopingClassViewController1
...
- (void)leftButClick:(UIButton *)but{
    MenuViewController1 * vc = [[MenuViewController1 alloc]init];
...
- (void)oneimageClick:(UIButton *)but{
    PeiJianViewController1  *peijian = [[PeiJianViewController1 alloc]init];
    [self.navigationController pushViewController:peijian animated:YES];
}
- (void)twoimageClick:(UIButton *)but{
    JiFenShopViewController1  *peijian = [[JiFenShopViewController1 alloc]init];
    [self.navigationController pushViewController:peijian animated:YES];
}
