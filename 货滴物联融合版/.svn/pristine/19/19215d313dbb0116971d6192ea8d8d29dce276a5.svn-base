//
//  MYYGoodsOrderViewController1.m
//  BaseFrame
//
...
@interface MYYGoodsOrderViewController1 ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MYYGoodsOrderViewController1{
...
- (void)dataRequest{
    ...
    NSDictionary* params = @{@"params":[NSString stringWithFormat:@"{\"orderstatus\":\"%@\"}",@"2"],@"page":[NSString stringWithFormat:@"%li",(long)_page],@"rows":@"8"};
