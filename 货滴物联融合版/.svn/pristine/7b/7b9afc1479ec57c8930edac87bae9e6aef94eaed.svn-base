...
#import "ZhaopinDingDTableViewCell.h"

@interface ZhaopinDingDViewController ()<UITableViewDataSource,UITableViewDelegate>
@property(nonatomic,strong)UITableView *tableview;
@property (nonatomic,strong)NSMutableArray * dataArr;
@end

@implementation ZhaopinDingDViewController
...
- (void)loadNewSearchSuyunorder
{
    ...
    NSString *URLStr = @"/mbtwz/driverrecruit?action=selectDriverRecruitListSelf";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    static NSString * stringCell = @"ZhaopinDingDTableViewCell";
    ZhaopinDingDTableViewCell * cell = [tableView dequeueReusableCellWithIdentifier:stringCell];
    if (cell == nil) {
    ...
    if (_dataArr.count) {
        ...
        cell.joincount.text = [NSString stringWithFormat:@"已有%@个司机接单",model.joincount];
...
- (void)butClick:(UIButton *)but{
    ...
    ZhaopinDingDetailsViewController *details = [[ZhaopinDingDetailsViewController alloc]init];
    details.id = model.id;
