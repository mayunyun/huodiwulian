//
//  MyLineDetailsViewController1.m
//  BasicFramework
//
...
@interface MyLineDetailsViewController1 ()<UITableViewDelegate,UITableViewDataSource,DWTagViewDelegate, DWTagViewDataSource>
@property(nonatomic,strong)UITableView *tableview;
@property(nonatomic,strong)NSMutableArray *dataArr;

@end

@implementation MyLineDetailsViewController1
...
- (void)viewDidLoad {
    ...
    titleLab.text = [NSString stringWithFormat:@"%@-%@",_sprovince,_eprovince];
    ...
    [_oneBut setTitle:@"出发地" forState:UIControlStateNormal];
    ...
    button.frame = CGRectMake(UIScreenW - 120, 10, 50, 40);
...
-(void)addNext{
    LineSetViewController1 *line = [[LineSetViewController1 alloc]init];
    line.routeid = self.routeid;
    line.remind = self.remind;
