...
#import "MyPingLunTableViewCell1.h"

@interface MyPingLunTableViewCell1()
...
@implementation MyPingLunTableViewCell1
...
- (void)setData:(MyPingLModel1 *)data
{
    _data = data;
