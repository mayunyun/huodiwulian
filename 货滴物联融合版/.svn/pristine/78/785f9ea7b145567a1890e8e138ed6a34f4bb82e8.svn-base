...
@interface CarBrandViewController1 ()<UITableViewDataSource,UITableViewDelegate,UITextFieldDelegate>{
...
@implementation CarBrandViewController1
...
- (UITableView *)tableview{
    if (_tableview == nil) {
        ...
        [_tableview registerClass:[CarBrandTableViewCell1 class] forCellReuseIdentifier:NSStringFromClass([CarBrandTableViewCell1 class])];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    Class CarBrandClass = [CarBrandTableViewCell1 class];
    CarBrandTableViewCell1 *cell = nil;
    
    cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass(CarBrandClass)];
    
    cell.selectionStyle = UITableViewCellSelectionStyleNone;
    cell.backgroundColor = [UIColor whiteColor];
    CarBrandModel1 *model;
    if (_dataArr.count) {
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    CarDetailViewController1* vc = [[CarDetailViewController1 alloc]init];
    CarBrandModel1 *model;
    if (_dataArr.count) {
        model = [self.dataArr objectAtIndex:indexPath.row];
