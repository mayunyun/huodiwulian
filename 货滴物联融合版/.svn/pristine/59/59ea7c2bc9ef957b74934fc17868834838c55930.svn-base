...
//        _leftBtn.layer.borderColor = UIColorFromRGBValue(MYColor).CGColor;
//        _leftBtn.layer.borderWidth = 1.0f;
//        _leftBtn.layer.masksToBounds = YES;
        _leftBtn.titleLabel.font = [UIFont systemFontOfSize:15.0f];
        [_leftBtn setTitleColor:UIColorFromRGBValueValue(0x333333) forState:UIControlStateNormal];
...
//        _rightBtn.layer.masksToBounds = YES;
        ...
        [_rightBtn setTitleColor:UIColorFromRGBValueValue(0x333333) forState:UIControlStateNormal];
