...
#import "ErSCCollectionViewCell1.h"
#import "ErSCModel1.h"
...
@interface ErSCshopViewController1 ()<SDCycleScrollViewDelegate,UICollectionViewDelegate,UICollectionViewDataSource,DWTagViewDelegate, DWTagViewDataSource>
@property(nonatomic,strong)UICollectionView *collection;
@property (nonatomic,strong)SDCycleScrollView *cycleScrollView2;

@end

@implementation ErSCshopViewController1
{
...
-(void)addNext{
    [Command isloginRequest:^(bool str) {
        if (str) {
            MyErSCViewController1 *myersh = [[MyErSCViewController1 alloc]init];
...
- (void)creatUI
{
    ...
    [_collection registerNib:[UINib nibWithNibName:@"ErSCCollectionViewCell1" bundle:nil] forCellWithReuseIdentifier:@"ErSCCollectionViewCell1ID"];
...
{
    static NSString *HomeSelarCellID = @"ErSCCollectionViewCell1ID";
    //在这里注册自定义的XIBcell 否则会提示找不到标示符指定的cell
    UINib *nib = [UINib nibWithNibName:@"ErSCCollectionViewCell1" bundle: [NSBundle mainBundle]];
    [_collection registerNib:nib forCellWithReuseIdentifier:HomeSelarCellID];
    
    ErSCCollectionViewCell1*cell = [collectionView dequeueReusableCellWithReuseIdentifier:HomeSelarCellID forIndexPath:indexPath];
...
-(void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    ErSCModel1* model = _DataArray[indexPath.row];
    
    ErSCshopDateViewController1 *ersc = [[ErSCshopDateViewController1 alloc]init];
...
- (void)twoClick{
    ...
    PinpaiSousuoViewController1 *pinpai = [[PinpaiSousuoViewController1 alloc]init];
