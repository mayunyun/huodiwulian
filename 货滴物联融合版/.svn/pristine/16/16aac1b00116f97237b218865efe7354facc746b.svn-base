...
@interface HDSousuoViewController1 ()<UITableViewDataSource,UITableViewDelegate,UITextFieldDelegate>{
    NSInteger _page;
...
@implementation HDSousuoViewController1
...
- (UITableView *)tableview{
    if (_tableview == nil) {
        _tableview = [[UITableView alloc]initWithFrame:CGRectMake(0, 0, kScreenWidth, kScreenHeight+NavBarHeight)];
