...
@interface MyErSCshopViewController1 ()<UICollectionViewDelegate,UICollectionViewDataSource>
{
...
@implementation MyErSCshopViewController1
...
- (void)creatUI
{
    ...
    [_collection registerNib:[UINib nibWithNibName:@"ErSCCollectionViewCell1" bundle:nil] forCellWithReuseIdentifier:@"ErSCCollectionViewCell1"];
...
{
    static NSString *HomeSelarCellID = @"ErSCCollectionViewCell1";
