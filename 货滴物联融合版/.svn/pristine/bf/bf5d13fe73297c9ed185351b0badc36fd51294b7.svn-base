...
#import "ZYCollectionView1.h"
#import "BannerCollectionViewCell1.h"
#define ZYCycleID @"ZYCycleID"

@interface ZYCollectionView1 ()<UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout>
...
@implementation ZYCollectionView1
...
- (void)createCycleView {
    ...
    [_cycleCollectionView registerClass:[BannerCollectionViewCell1 class] forCellWithReuseIdentifier:ZYCycleID];
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    BannerCollectionViewCell1 * cell = [collectionView dequeueReusableCellWithReuseIdentifier:ZYCycleID forIndexPath:indexPath];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    if ([self.delegate respondsToSelector:@selector(ZYCollectionView1Click:strID:)]) {
        self.index = [self indexWithOffset:indexPath.item];
        NSInteger imageIndex       = self.index;
        HuoDongModel1 * model = self.imagesArr[imageIndex];
        [self.delegate ZYCollectionView1Click:[self indexWithOffset:indexPath.item] strID:model];
    }
}
