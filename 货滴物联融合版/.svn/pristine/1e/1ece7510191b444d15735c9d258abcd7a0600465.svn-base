...
#import "BasicWebVC1.h"
#import "BasicWebView1.h"

@interface BasicWebVC1 ()<WKNavigationDelegate>

@property(nonatomic,strong)BasicWebView1 *webParentView;

@end

@implementation BasicWebVC1
...
#pragma mark - lazy
-(BasicWebView1 *)webParentView
{
    if (!_webParentView) {
        
        _webParentView = [[BasicWebView1 alloc] initWithFrame:self.view.bounds canCopy:YES canZoom:NO];
