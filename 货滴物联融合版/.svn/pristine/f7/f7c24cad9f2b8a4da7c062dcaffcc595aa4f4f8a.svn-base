...
@interface CarshopViewController1 ()

@end

@implementation CarshopViewController1
...
- (void)viewTapped{
    ErSCshopViewController1 *HuodongVC = [[ErSCshopViewController1 alloc]init];
    HuodongVC.type = @"1";
